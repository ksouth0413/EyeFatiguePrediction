...
predictor = dlib.shape_predictor('/Users/namhunkim/Downloads/작업중/code/Practice2(usingKeras)/shape_predictor_68_face_landmarks.dat')

model = load_model('/Users/namhunkim/Downloads/작업중/code/Practice2(usingKeras)/models/2018_12_17_22_58_35.h5')
model.summary()
